 ...
 * 
 */
@WebServiceClient(name = "ServicioSumarImplService", targetNamespace = "http://beans.adanyc.com.pe/", wsdlLocation = "http://localhost:9090/ServicioSumarImplService/ServicioSumarImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOSUMARIMPLSERVICE_QNAME = new QName("http://beans.adanyc.com.pe/", "ServicioSumarImplService");
    ...
    public ServicioSumarWS getServicioSumarImplPort() {
        return super.getPort(new QName("http://beans.adanyc.com.pe/", "ServicioSumarImplPort"), ServicioSumarWS.class);
    }
    ...
    public ServicioSumarWS getServicioSumarImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://beans.adanyc.com.pe/", "ServicioSumarImplPort"), ServicioSumarWS.class, features);
    }
